...
from arduinobot_msgs.srv import EulerToQuarternion
from arduinobot_msgs.srv import QuarternionToEuler
...
class AnglesConverter(Node):
    ...
    def __init__(self):
        ...
        self.euler_to_quaternion_ = self.create_service(EulerToQuarternion, "euler_to_quaternion", self.eulerToQuaternionCallback)
        self.quaternion_to_euler_ = self.create_service(QuarternionToEuler, "quaternion_to_euler", self.quaternionToEulerCallback)
